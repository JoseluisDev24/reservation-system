...
export default function Footer() {
  return (
    <footer id="footer" className="bg-gradient-to-b from-gray-900 to-black border-t-2 border-green-500 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <Link href="/" className="text-3xl font-[family-name:var(--font-bebas)] tracking-wider mb-4 text-green-400">
            RESERVÁ5
          </Link>
          <p className="text-gray-400">
            La forma más fácil de reservar canchas de fútbol, padel y tennis.
          </p>
        </div>
